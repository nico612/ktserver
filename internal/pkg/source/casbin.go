...
import (
	"context"
	adapter "github.com/casbin/gorm-adapter"
...
var _ initdb.SubInitializer = (*initCasbin)(nil)
...
func (i *initCasbin) MigrateTable(ctx context.Context) (next context.Context, err error) {
